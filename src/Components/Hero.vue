        ...
        <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 items-center">
         ...
         <!-- bouton cv et contacter -->
          <div class="flex flex-col pt-8 gap-4 sm:flex-row sm:mx-auto sm:w-max lg:mx-0" data-aos="fade-up" data-aos-delay="300">
            ...
            <!-- 2eme button -->
            <a href="/CV_ANDRIATSITOHAINARIVO_Jaffrelot.pdf" download="CV_ANDRIATSITOHAINARIVO_Jaffrelot.pdf" class="border-2 text-blue-400 border-blue-400 group px-8 py-4 rounded-xl w-full sm:w-max hover:bg-blue-400/10 transition-all duration-300">
